...
//CLock
	...
	JTextArea title = new JTextArea("   WELCOME TO CUI LEISURE CLUB");
	JTextArea title1 = new JTextArea("   SIGN IN WITH CREDENTIALS ");
	JTextArea title2 = new JTextArea("     FILL ALL THE FIELDS CAREFULLY \n\t*** SIGN UP ***  ");
	JTextArea title3 = new JTextArea(" WELCOME TO CUI LEISURE CLUB ");
	...
	JTextArea emo = new JTextArea("    DAY:  ");
	...
	JTextArea eschool = new JTextArea("  INSTITUTE:  ");
...
String [] month = {"Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"};
	...
	String[] NameOfCoaches = { "Ali ", "Tahir", "Huzaifa", "Shaharyar", "Umair" };
	String[] Timing = { "5PM-6PM", "6:30PM-7:30PM", "8PM-9PM", "9PM-10PM", "10PM-11:30PM" };
	String[] coursesNames = { "Cricket", "FootBall", "VolleyBall", "Table Tennis", "Hockey" };
	...
	JButton procceed = new JButton("PROCEED");
	...
	public GUI() {
		...
		frame.setTitle("The CUI Leisure Centre");
		...
		title2.setBounds(220, 50, 350, 50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == conf) {
			...
			JOptionPane.showMessageDialog(frame, "SIGN UP FOR COURSE SUCCESSFULLY");
...

		{
			...
			if (ename1.getText().trim().length() == 0 || eaddress1.getText().trim().length() == 0
					|| epassword1.getText().trim().length() == 0 || eschool1.getText().trim().length() == 0
					|| econtact1.getText().trim().length() == 0) {

				toast t = new toast("PLEASE FILL ALL FIELDS", 350, 550);
				t.showtoast();
