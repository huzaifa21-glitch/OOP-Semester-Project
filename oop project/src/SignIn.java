...
public class SignIn implements Sign {
	...
	public boolean verify(String idw, String Passw) {
		try {
			...
			toast t = new toast("Invalid ID or PASSWORD",350,450);
			t.showtoast();
...
//			JFrame frame = new JFrame("FAILED");
			toast t = new toast("Sorry Can't Fetch DATA",350,550);
			t.showtoast();
//			JOptionPane.showMessageDialog(frame, "Sorry Can't Fetch DATA");
			return saa;
		}
